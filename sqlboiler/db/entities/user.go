...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to populate default values for user")
	}
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to upsert for user")
	}
	...
	if err != nil {
		return errors.Wrap(err, "entities: unable to retrieve unique values for user")
	}
